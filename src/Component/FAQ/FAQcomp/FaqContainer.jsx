...
import Question from "../FAQcomp/Assets/Framequestion.png";
			...
			<div className={Style.faqWrapper}>
				<div className={Style.faqQuestions}>
					<div className={Style.question}>
						...
						<h3>What does Certawi Certificate Generator do?</h3>
					</div>
				...
				<div className={Style.faqAnswers}>
					<p>
						Certawi generates professionally designed certificates for your
						staff, students etc. You also get to generate certificates in bulk
						and download in any format of your choice, for free & no sign up
						required.
					</p>
				</div>
			</div>
