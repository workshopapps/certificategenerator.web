    ...
    <main>
      <section className="pricing">
        <article className="text">
          ...
          <p>
            Buy a plan that's right for you. With Certawi you can tailor your
            plan to suit your budget and needs. Choose to upgrade or downgrade
            your plan at any time – it's up to you!
          </p>
        </article>
          ...
          >
            <SplideSlide>
              <div className="testimonial-boxn test">
                ...
                <p className="testimonial-test">
                  ...
                  huge selection of templates, fonts, and colors; endless
                  choices at the tip of your fingers; easy editing and
                  sending/sharing. Best certificate generator I've used for a
                  long time. If you haven't tried it... try it! Victor Hayworth”
                </p>
              </div>
            </SplideSlide>
            ...
            <SplideSlide>
              <div className="testimonial-boxn">
                ...
                <p className="testimonial-test">
                  ...
                  and helps us navigate the software and recommend a solution
            ...
            <SplideSlide>
              <div className="testimonial-boxn">
                ...
                <p className="testimonial-test">
                  ...
                  enrolled in my courses. The various letter font styles and
                  font colors are wonderful to choose from. The final look and
                  design of the certification are professional. I enjoy using
                  this easy website.”
                </p>
              </div>
            </SplideSlide>
            ...
            <SplideSlide>
              <div className="testimonial-boxn">
                ...
                <p className="testimonial-test">
                  “Easy, simple, and fast. The ease of use is really
                  commendable. Setup and configuration is quite fast and simple.
                  I found it really handy in sending out digital certificates
                  for our bootcamp. The certification process has become
                  seamless with only 3 steps to take in order to issue the
                  credentials.”
                </p>
              </div>
            </SplideSlide>
            ...
            <SplideSlide>
              <div className="testimonial-boxn">
                ...
                <p className="testimonial-test">
                  ...
                  frames as they look very professional. It is quite
                  affordable.”
                </p>
              </div>
            </SplideSlide>
