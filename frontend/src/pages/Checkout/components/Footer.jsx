import Logo2 from "../../../assets/svgs/checkout/Logo 2.svg";
import Instagram from "../../../assets/svgs/checkout/Instagram.svg";
import Linkedin from "../../../assets/svgs/checkout/Linkedin.svg";
import Twitter from "../../../assets/svgs/checkout/Twitter.svg";
import Github from "../../../assets/svgs/checkout/Github.svg";
  ...
  return (
    <div className="container-fluid" id="Footer-main-container">
      <div className="row" id="Footer-row">
        <div
          className="col-xs-4 col-sm-4 col-md-4 col-lg-2 col-xl-2 col-xxl-2"
          id="Footer-row-col-1"
        >
          <ul id="Footer-list">
        ...
        >
          ...
          <div className="row" id="Footer-row-col-4-div">
            <div
              className="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xxl-8"
              id="Footer-row-col-4-div-col"
            >
              <input
                type="text"
                placeholder="Your Email"
                id="Footer-row-col-4-input"
              />
            </div>
            <div
              className="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4"
              id="Footer-row-col-4-div-col"
            >
        ...
        <div
          className="col-xs-12 col-sm-12 col-md-4 col-lg-2 col-xl-2 col-xxl-2"
          id="Footer-row-col-5"
        >
      ...
      <h4 id="Footer-main-text">
        © Copyright 2022 <span id="Footer-sub-text">Team Headlight.</span> All
        rights reserved.
      </h4>
    </div>
  );
