    ...
    >
      <div className="container-fluid" id="CheckoutMainRight-container-sub">
        <p id="CheckoutMainRight-text-container">
          ...
          <span id="CheckoutMainRight-text-3">
            More features customised for you
          </span>{" "}
          <br /> <br />
        ...
        <CheckoutMainRightComp
          text="Generate 500 certificates per month"
          id="CheckoutMainRightComp-main"
        />

        <CheckoutMainRightComp
          text="Send to specified mails in CSV"
          id="CheckoutMainRightComp-main"
        />

        <CheckoutMainRightComp
          text="Access to dashboard interface"
          id="CheckoutMainRightComp-main"
        />

        <CheckoutMainRightComp
          text="Basic integrations"
          id="CheckoutMainRightComp-main-last"
        />
      </div>
    </div>
  );
