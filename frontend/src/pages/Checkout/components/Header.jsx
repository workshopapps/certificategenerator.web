...
import Logo from "../../../assets/svgs/checkout/Logo.svg";
import Profile from "../../../assets/svgs/checkout/Profile.svg";

function Header() {
  return (
    <Navbar collapseOnSelect expand="lg" id="Header-main-container">
      <Container>
        <Navbar.Brand href="/" id="logo-text">
          <img src={Logo} alt="logo" />
        </Navbar.Brand>
        <Navbar.Toggle
          aria-controls="Header-navbar-navbarScroll"
          data-bs-target="#Header-navbar-navbarScroll"
          id="Header-navbar-toggle"
        />
        <Navbar.Collapse
          id="Header-navbar-navbarScroll"
          className="justify-content-end text-start"
        >
          <Nav id="Header-nav">
