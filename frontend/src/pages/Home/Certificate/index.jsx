    ...
    return (
        <>
          ...
          <div className="flex justify-between mode">
            <button className="select" style={{color: '#222222', backgroundColor: '#ffffff', transition: '300ms ease-in', fontWeight: '400'}}  onClick={() => {setBulkCertificate(false)}}>Single <span className="mobile-none">Certificate</span></button>
          ...
          <div className="flex justify-between mode">
            ...
            <button className="select" style={{color: '#222222', backgroundColor: '#ffffff', transition: '300ms ease-in', fontWeight: '400'}} onClick={() => {setBulkCertificate(true)}}>Bulk <span className="mobile-none">Certificate</span></button>
          </div>
        }
